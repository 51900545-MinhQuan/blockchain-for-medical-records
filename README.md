...
3. Logo landscape phù hợp cho header nếu có
...
4. Tích hợp blockchain và vào hệ thống.
5. Chuyển database online, deploy web online
...
1. server: sử dụng Render free
2. blockchain: sử dụng Web3
3. database: tạo mongodb atlas cluster
4. smart contract: testnet Polygon Mumbai, Remix IDE, Metamask
5.
